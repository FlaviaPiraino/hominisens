...
## Mise à jour du 27/07/2026 — avis Google, prise en charge, responsive (terminée ✅)
- Bouton « Lire les avis Google » (accueil) : pointait vers le formulaire de RÉDACTION d'avis ; pointe désormais vers la fiche Google Maps de l'établissement (lecture des avis). Les liens du pied de page conservent le lien de rédaction mais sont renommés « Laisser un avis Google » pour refléter leur fonction — utile pour récolter des avis.
- Page prise-en-charge, « Votre prise en charge en 3 étapes » : étape 1 renommée « Votre demande de prise en charge ».
- Revue responsive complète. Déjà en place et vérifié : typo fluide (clamp), menu burger <900 px, barre d'actions mobile fixe, cibles tactiles 44 px, grilles auto-adaptatives, images fluides, palier tablette, aucun tableau, viewport sur les 17 pages, pas de zoom iOS sur les champs (corps ≥16 px). Ajouts (@media 640 px) : bandeau de réassurance empilé et centré (corrige le centrage de « Praticienne… RNCP depuis 2018 » sur téléphone), galerie en 2 colonnes, bloc chiffres en 2 colonnes, marges entre boutons quand ils passent à la ligne (bouton d'envoi du formulaire préservé centré).
